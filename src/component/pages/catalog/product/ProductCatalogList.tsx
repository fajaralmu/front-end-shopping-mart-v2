        ...
        return (
            <Modal title="Product List">
                <div className="btn-group" style={{ marginBottom: '5px' }}>
                    <AnchorButton onClick={this.showShoppingCart} show={showCart == false} className="btn btn-light" iconClassName="fas fa-angle-down">Show Shopping Cart</AnchorButton>
                    <AnchorButton onClick={this.hideShoppingCart} show={showCart == true} className="btn btn-light" iconClassName="fas fa-angle-up">Hide Shopping Cart</AnchorButton>
                    <AnchorButton onClick={this.resetAllShoppingCart} show={showCart == true} className="btn btn-danger" iconClassName="fas fa-cart-arrow-down">Reset Cart</AnchorButton>
                </div>
                <div className="row">
